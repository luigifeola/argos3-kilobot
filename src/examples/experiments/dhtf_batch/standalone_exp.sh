...
# ./src/examples/experiments/dhtf_batch/standalone_exp.sh /src/examples/experiments/dhtf_batch dhtf_experiment.argos
...
for par1 in $timeout; do
    param_dir=$res_dir/"standalone_"$date_time"_robots#"$numrobots"_timeout#"$par1"_redAreas#"$hard_tasks"_"$experiment_length"#seconds"
