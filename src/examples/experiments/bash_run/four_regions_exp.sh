...
# ./src/examples/experiments/bash_run/four_regions_exp.sh /src/examples/experiments/bash_run dhtfs_4_regions_experiment.argos dhtfc_experiment.argos
...
for par1 in $timeout; do
    param_dir=$res_dir/"four_regions_"$date_time"_robots#"$numrobots"_timeout#"$par1"_redAreas#"$hard_tasks"_"$experiment_length"seconds"
